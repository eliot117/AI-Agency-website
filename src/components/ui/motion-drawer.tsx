...
export const MotionDrawer: React.FC<SideMenuProps> = ({
  overlayColor = 'rgba(0, 0, 0, 0.3)',
  width = 250,
  direction = 'left' as SideMenuDirection,
  ...
  enableDrag = true,
  dragThreshold = 0.3,
  buttonOpeningVariants = 'merge' as ButtonOpeningVariants,
}) => {
  ...
  return (
    <>
      {showToggleButton && (
        <motion.button
          className={cn(
            `fixed z-40 text-primary cursor-pointer ${openButtonPositionClasses}`,
            btnClassName
          )}
